class Ui{
    ...
    update(){
        ...
        this.scoreBoard2.innerText = this.game.player2.name + ': '  + this.game.player1.score;
        this.scoreBoard3.innerText = this.game.player3.name + ': '  + this.game.player1.score;
        this.scoreBoard4.innerText = this.game.player4.name + ': '  + this.game.player1.score;
    }
}